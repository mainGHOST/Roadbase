    ...
    <nav class="container-fluid px-5 py-4">
        <div class="flex-between">
            ...
            <div class="flex-between gap-2">
                ...
                <div class="btn btn-outline-light">Create Account</div>
            </div>
        </div>
    </nav>
    <div class="flex-between">
                ...
                <div class="modal-content">
                    <div class="card" style="width: 500px;">
                        <div class="card-body d-flex flex-column gap-4 justify-content-center align-items-center">
                            ...
                            <h2 class="">Sign in</h2>
                            <form class="d-flex flex-column justify-content-center align-items-center gap-4 flex-column">
                                ...
                                <div class="flex-between flex-column gap-2 my-3">
                                    <a href="" class="text-primary">Sign in with wallet</a>
